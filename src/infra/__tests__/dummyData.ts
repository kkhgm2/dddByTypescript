...
const teamMemberCountDesc = [
    { teamId: 7, _count: { teamId: 3 } },
    { teamId: 5, _count: { teamId: 1 } },
    { teamId: 4, _count: { teamId: 1 } }
]

const teamMemberCountAsc =
    [
        { teamId: 5, _count: { teamId: 1 } },
        { teamId: 4, _count: { teamId: 1 } },
        { teamId: 7, _count: { teamId: 3 } }
...
export {
    teamMembers1, teamMembers2, allTeam, oneTeam, manyTeam, memberInfo1, memberInfo2
    , teamMemberCountDesc, teamMemberCountAsc
};
